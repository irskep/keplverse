...
*/
export function addPlanets(starSystem, getRandom) {
    ...
    */
    ...
    var _a = computeHabitableZone(starSystem.stars[0].starType, starSystem.stars[0].luminosity), hzMin = _a[0], hzMax = _a[1];
    ...
    */
    ...
    var forceHZTerran = starSystem.stars[0].starType == StarType.M && getRandom() < 0.5;
    if (forceHZTerran) {
        start = numHotSlots;
    }
    var left = start;
    ...
    function makePlanet(i, t) {
        ...
        var starType = weightedRandom(planetTypeChoices, getRandom());
        if (t) {
            starType = t;
        }
        starSystem.planets.push(new Planet(starType, starSystem.stars[0], planetSlots[i]));
    }
    if (forceHZTerran) {
